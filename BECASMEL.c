...
void main(){
	...
	int numero, i, umbral;
	float beca;
	float distancia, notamedia, resultado, resultado2, resultado3, resultado4, resultado5, resultado6;
				...
				if (estudio == 1){
					...
					switch(umbral){
						case 1:
							...
							resultado=bachilleratoUmbral1(distancia,notamedia);
						...
						case 2:
							...
							resultado2=bachilleratoUmbral2(distancia,notamedia);
						...
						case 3:
							...
							resultado3=bachilleratoUmbral3(notamedia);
					...
					printf("Usted ha seleccionado Universidad\n");
					printf("Introduce el numero de miembros en tu unidad familiar (si son mas de 3 pulsa 3):\n");
					scanf("%d", &numero);
					...
					switch(umbral){
						case 1:
							...
							resultado4=uniUmbral1(distancia,notamedia);
						...
						case 2:
							...
							resultado5=uniUmbral2(distancia,notamedia);
						...
						case 3:
							...
							resultado6=uniUmbral3(notamedia);
...
float bachilleratoUmbral1(float distancia, float notamedia) {
	float resultado;
	resultado=2*distancia*notamedia+1600;
	return resultado;
}

float bachilleratoUmbral2(float distancia, float notamedia){
	float resultado2;
	resultado2=2*distancia*notamedia+200;
	return resultado2;
}

float bachilleratoUmbral3(float notamedia){
	float resultado3;
	resultado3=2*notamedia+200;
	return resultado3;
}

float uniUmbral1(float distancia, float notamedia){
	float resultado4;
	resultado4=2*distancia*notamedia+3200; // 1600 por la renta y 1600 por la matrícula. 
	return resultado4;
}

float uniUmbral2(float distancia, float notamedia){
	float resultado5;
	resultado5=2*distancia*notamedia+1600;
	return resultado5;
}

float uniUmbral3(float notamedia){
	float resultado6;
	resultado6=2*notamedia+1600;
	return resultado6;
}
